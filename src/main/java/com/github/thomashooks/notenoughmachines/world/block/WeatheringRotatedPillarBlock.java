...
public class WeatheringRotatedPillarBlock extends RotatedPillarBlock implements IWeatheringBlock
{
    ...
    public WeatheringRotatedPillarBlock(IWeatheringBlock.State weatherState, Properties properties)
    {
        super(properties);
    ...
    @Override
    public @NotNull IWeatheringBlock.State getAge() { return this.weatherAge; }
