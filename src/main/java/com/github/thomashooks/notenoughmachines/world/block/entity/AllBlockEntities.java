...
public class AllBlockEntities
{
    ...
    public static final RegistryObject<BlockEntityType<ItemDuctBlockEntity>> ITEM_DUCT = BLOCK_ENTITIES.register("item_duct", () -> BlockEntityType.Builder.of(ItemDuctBlockEntity::new, AllBlocks.ITEM_DUCT.get()).build(null));
