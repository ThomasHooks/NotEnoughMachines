...
public class CommonConfigs
{
    ...
    static
    {
        ...
        HIGH_SPEED_RAIL_MAX_SPEED = BUILDER.comment("The maximum speed of a minecart while it's on a high-speed rail").define("High-Speed Rail's Max Speed", 0.8F);
        ...
        HIGH_SPEED_RAIL_MAX_SPEED_MINECART_FURNACE = BUILDER.comment("The maximum speed of a furnace minecart while it's on a high-speed rail").define("Furnace Minecart's Max Speed on High-Speed Rail", 0.4F);
        ...
        HIGH_SPEED_POWERED_RAIL_BOOST_FACTOR = BUILDER.comment("The boost factor of a minecart while it's on a high-speed powered rail").define("High-Speed Powered Rail's Boost Factor", 0.08F);
        HIGH_SPEED_POWERED_RAIL_LAUNCH_FACTOR = BUILDER.comment("The launch factor of a minecart while it's on a high-speed powered rail").define("High-Speed Powered Rail's Launch Factor", 0.04F);
