...
public class SingleIngredientRecipeBuilder implements RecipeBuilder
{
    ...
    protected SingleIngredientRecipeBuilder(Ingredient ingredient, ItemLike result, int count, int processingTime, RecipeSerializer<?> serializerIn)
    {
     ...
     */
    public static SingleIngredientRecipeBuilder millingRecipe(Ingredient ingredient, ItemLike result, int count, int processingTime)
    {
        return new SingleIngredientRecipeBuilder(ingredient, result, count, processingTime, MillingRecipe.Serializer.MILLING);
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation resourceLocation)
    {
        ...
        consumer.accept(new SingleIngredientRecipeBuilder.Result(
                resourceLocation,
