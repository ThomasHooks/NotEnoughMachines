package com.github.thomashooks.notenoughmachines.data.worldgen.features;
...
public class CustomOreFeatures
{
    ...
    {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(NotEnoughMachines.MOD_ID, name));
    }
