...
public class RecipesDataGen extends RecipeProvider {
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		StampingRecipeBuilder.stampingRecipe(Ingredient.fromItems(Blocks.IRON_ORE), NEMItems.CRUSHED_IRON_ORE.get(), 2, 900)
		...
		StampingRecipeBuilder.stampingRecipe(Ingredient.fromItems(Blocks.GOLD_ORE), NEMItems.CRUSHED_GOLD_ORE.get(), 2, 900)
