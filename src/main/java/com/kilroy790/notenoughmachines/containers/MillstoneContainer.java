...
public class MillstoneContainer extends NEMBaseContainer<MillstoneTile> 
{
	...
	public MillstoneContainer(int id, PlayerInventory inventory, MillstoneTile tile)
	{
		super(NEMContainers.MILLSTONE.get(), id, inventory, tile);
	...
	public MillstoneContainer(final int id, final PlayerInventory inventory, final PacketBuffer data) 
	{
		this(id, inventory, (MillstoneTile)inventory.player.world.getTileEntity(data.readBlockPos()));
	}
