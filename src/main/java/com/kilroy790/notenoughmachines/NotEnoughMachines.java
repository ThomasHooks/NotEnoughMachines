...
import com.kilroy790.notenoughmachines.client.renderers.GearboxRenderer;
...
public class NotEnoughMachines {
	...
	private void clientRegistries(final FMLClientSetupEvent event) {
		...
		logger.info("Registering Gearbox TESR");
		ClientRegistry.bindTileEntitySpecialRenderer(GearboxTile.class, new GearboxRenderer());
