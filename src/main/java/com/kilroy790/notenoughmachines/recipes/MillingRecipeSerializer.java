...
public class MillingRecipeSerializer<T extends AbstractMachineRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T>{

	private final int processTime;
	private final MillingRecipeSerializer.IFactory<T> IAbstractMachineRecipeFactory;
