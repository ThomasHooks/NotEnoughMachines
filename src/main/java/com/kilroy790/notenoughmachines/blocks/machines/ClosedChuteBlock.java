...
public class ClosedChuteBlock extends Block {
	...
	private static final VoxelShape PUSHER_SHAPE = Block.makeCuboidShape(4.0D, 4.0D, 4.0D, 12.0D, 12.0D, 12.0D);
	private static final VoxelShape CHUTE_SHAPE_NORTH = VoxelShapes.or(PUSHER_SHAPE, Block.makeCuboidShape(5.0D, 5.0D, 3.0D, 11.0D, 11.0D, 4.0D));
	private static final VoxelShape CHUTE_SHAPE_EAST = VoxelShapes.or(PUSHER_SHAPE, Block.makeCuboidShape(12.0D, 5.0D, 5.0D, 13.0D, 11.0D, 11.0D));
	private static final VoxelShape CHUTE_SHAPE_WEST = VoxelShapes.or(PUSHER_SHAPE, Block.makeCuboidShape(3.0D, 5.0D, 5.0D, 4.0D, 11.0D, 11.0D));
	private static final VoxelShape CHUTE_SHAPE_SOUTH = VoxelShapes.or(PUSHER_SHAPE, Block.makeCuboidShape(5.0D, 5.0D, 12.0D, 11.0D, 11.0D, 13.0D));
	private static final VoxelShape CHUTE_SHAPE_UP = VoxelShapes.or(PUSHER_SHAPE, Block.makeCuboidShape(5.0D, 12.0D, 5.0D, 11.0D, 13.0D, 11.0D));
	private static final VoxelShape CHUTE_SHAPE_DOWN = VoxelShapes.or(PUSHER_SHAPE, Block.makeCuboidShape(5.0D, 3.0D, 5.0D, 11.0D, 4.0D, 11.0D));
	
	private static final VoxelShape TUBE_NORTH_SHAPE = Block.makeCuboidShape(6.0D, 6.0D, 0.0D, 10.0D, 10.0D, 6.0D);
	private static final VoxelShape TUBE_EAST_SHAPE = Block.makeCuboidShape(10.0D, 6.0D, 6.0D, 16.0D, 10.0D, 10.0D);
	private static final VoxelShape TUBE_SOUTH_SHAPE = Block.makeCuboidShape(6.0D, 6.0D, 10.0D, 10.0D, 10.0D, 16.0D);
	private static final VoxelShape TUBE_WEST_SHAPE = Block.makeCuboidShape(0.0D, 6.0D, 6.0D, 6.0D, 10.0D, 10.0D);
	private static final VoxelShape TUBE_UP_SHAPE = Block.makeCuboidShape(6.0D, 10.0D, 6.0D, 10.0D, 16.0D, 10.0D);
	private static final VoxelShape TUBE_DOWN_SHAPE = Block.makeCuboidShape(6.0D, 0.0D, 6.0D, 10.0D, 6.0D, 10.0D);
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
		...
		TileEntity tile = worldIn.getTileEntity(pos);
		if(tile instanceof ClosedChuteTile) {
