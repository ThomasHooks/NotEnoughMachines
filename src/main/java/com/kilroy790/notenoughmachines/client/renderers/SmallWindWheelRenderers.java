...
public class SmallWindWheelRenderers extends TileEntityRenderer<SmallWindWheelTile> {
	...
	private AxleModel axleModel = new AxleModel();
	private static final ResourceLocation axleTexture = new ResourceLocation("notenoughtmachines", "textures/block/axel_tesr.png");
	...
	public void render(SmallWindWheelTile tile, double x, double y, double z, float partialTicks, int destroyStage) {
		...
		this.axleModel.rotate(0.0f, 0.0f, rotationAngle);
		...
		this.bindTexture(axleTexture);
		this.axleModel.render(SCALE);
